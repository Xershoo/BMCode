...
//	getCourseStudent();
	...
	$("#unpay").on("mouseover",function(){
		$(this).css("background-color","#1A8EC3").css("cursor","pointer");
...
//                $(".positionWrap").css("height",hei+"px");
	...
	$(".c_top_right h1").html(cut_str(courseName, 30));
...
function getCourseInfos() {
	...
	$(".c_middle_left .piano-course").remove();
	$("#evaluate").hide();
	...
	$(".course_info").css("border-bottom", "3px solid #42b8f6");
	var url = getRootPath() + "/course/getCourseDetail";
	var courseId = $("#courseId").val();
	$.ajax({
				url : url,
...
//						html += '</div>';
						...
						$(".course_content").css({"width":"1095px","margin-left":"25px"});
					}
				}
			})
}
...
function getCourseDirectory(){
	...
	$(".course_data").css("border-bottom","0px");
	$(".course_evaluation").css("border-bottom","0px");
	$(".course_catalog").css("border-bottom","3px solid #42b8f6");
				...
				if(data.success ==true){
					...
					$.each(course,function(i, item){
						if(item.recordUrl != '' && item.recordUrl != null){
							html += '<div class="e_class_info pn-move" onClick=goViewTheVideo('+item.classid+')>';
						}else{
...
function getCourseComment() {
	...
	var pianoStatus = $.trim($("#pianoStatus").val());
	if((orderStatus == 2 || orderStatus == 3) && (pianoStatus == 30 || pianoStatus == 40 || pianoStatus == 41)){
		$("#evaluate").show();
	}
	$(".c_middle_left .course_content").remove();
	$(".c_middle_left .piano-course").remove();
	...
	$(".course_data").css("border-bottom", "0px");
	$(".course_catalog").css("border-bottom", "0px");
	$(".course_evaluation").css("border-bottom", "3px solid #42b8f6");
	...
	if (pageNum <= 1) {
		...
		html += '<h2>本课程的综合评分<font color="#f26665" style="font-size:22px;font-weight:700;">'
				+ avgScore + '</font>分</h2>';
		html += '</div>';
...
//							html += '<img alt="" src="../../images/c3-1-3createcourse/under_line.png" width="800px" style="margin-left:50px;">';
							...
							if (item.score == 5) {
								html += '<p><img alt="" src="../../images/course/y_star.png"><img alt="" src="../../images/course/y_star.png"><img alt="" src="../../images/course/y_star.png"><img alt="" src="../../images/course/y_star.png"><img alt="" src="../../images/course/y_star.png"><span class="st_time">'+ item.createTime+ '</span></p>';
							} else if (item.score == 4) {
								html += '<p><img alt="" src="../../images/course/y_star.png"><img alt="" src="../../images/course/y_star.png"><img alt="" src="../../images/course/y_star.png"><img alt="" src="../../images/course/y_star.png"><img alt="" src="../../images/course/y_e_star.png"><span class="st_time">'+ item.createTime+ '</span></p>';
							} else if (item.score == 3) {
								html += '<p><img alt="" src="../../images/course/y_star.png"><img alt="" src="../../images/course/y_star.png"><img alt="" src="../../images/course/y_star.png"><img alt="" src="../../images/course/y_e_star.png"><img alt="" src="../../images/course/y_e_star.png"><span class="st_time">'+ item.createTime+ '</span></p>';
							} else if (item.score == 2) {
								html += '<p><img alt="" src="../../images/course/y_star.png"><img alt="" src="../../images/course/y_star.png"><img alt="" src="../../images/course/y_e_star.png"><img alt="" src="../../images/course/y_e_star.png"><img alt="" src="../../images/course/y_e_star.png"><span class="st_time">'+ item.createTime+ '</span></p>';
							} else if (item.score == 1) {
								html += '<p><img alt="" src="../../images/course/y_star.png"><img alt="" src="../../images/course/y_e_star.png"><img alt="" src="../../images/course/y_e_star.png"><img alt="" src="../../images/course/y_e_star.png"><img alt="" src="../../images/course/y_e_star.png"><span class="st_time">'+ item.createTime+ '</span></p>';
							} else if(item.score == 0){
								html += '<p><img alt="" src="../../images/course/y_e_star.png"><img alt="" src="../../images/course/y_e_star.png"><img alt="" src="../../images/course/y_e_star.png"><img alt="" src="../../images/course/y_e_star.png"><img alt="" src="../../images/course/y_e_star.png"><span class="st_time">'+ item.createTime+ '</span></p>';
							}else {
								html += '<p><img alt="" src="../../images/course/y_e_star.png"><img alt="" src="../../images/course/y_e_star.png"><img alt="" src="../../images/course/y_e_star.png"><img alt="" src="../../images/course/y_e_star.png"><img alt="" src="../../images/course/y_e_star.png"><span class="st_time">'+ item.createTime+ '</span></p>';
							}
//							html += '<span class="st_time">'+ item.createTime+ '</span>';
							html += '<p>' + item.content
									+ '</p>';
							html += '</div>';
							html += '</div>';
		...
		html += '</div>';
		$(".c_middle_left").append(html);
		$(".course_content").css({"width":"1160px","margin-left":"0px"});
	} else {
...
//	$("#course_evaluation").css("color","#546d7e");
	...
	$(".course_evaluation").css("border-bottom","0px");
	$(".course_catalog").css("border-bottom","0px");
	$(".course_data").css("border-bottom","3px solid #42b8f6");
...
function getOtherPianoCourses(){
	...
	if (pageNum <= 1) {
		var html = '';
		$.each(otherCourses, function(i, item) {
			if(i == 0 || i % 5 == 0){
				html += '<div class="piano-course" onclick="goCourseUrl('+item.courseid+')">';
			}else{
				html += '<div class="piano-course piano-distance" onclick="goCourseUrl('+item.courseid+')">';
			}
			html += '<div class="course-img">';
			html += '<img src="'+item.coverUrl+'" alt="" class="img-info">';
			html += '</div>';
			html += '<div class="pn-cor-name">'+cut_str(item.courseName, 12)+'</div>';
			if(item.priceTotal == null || item.priceTotal == '' || item.priceTotal == '0.0' || item.priceTotal == '0'){
				html += '<div class="pn-cor-price">免费</div>';
			}else{
				html += '<div class="pn-cor-price">￥'+item.priceTotal+'元</div>';
			}
			html += '</div>';
		})
		$(".c_middle_left").append(html);
		...
		$("#page").myPagination({
			...
			ajax : {
				on : true,
				callback : 'callBackOtherPianoData',
				url : url,
				dataType : "json",
				cache : false,
				param : {
...
function callBackOtherPianoData(data) {
	var data = eval("(" + data + ")");
	var pianoCourses = data.result.list;
	$("#page").css("display","block");
	$("#course_info").removeClass("course_color");
	$("#course_catalog").removeClass("course_color");
	$("#course_evaluation").removeClass("course_color");
	...
	$(".course_data").css("border-bottom","3px solid #42b8f6");
	var html = '';
	$.each(pianoCourses, function(i, item) {
		if(i == 0 || i % 5 == 0){
			html += '<div class="piano-course" onclick="goCourseUrl('+item.courseid+')">';
		}else{
			html += '<div class="piano-course piano-distance" onclick="goCourseUrl('+item.courseid+')">';
...
function goViewTheVideo(classId){
	location.href = getRootPath() + '/course/view/' + classId;
}
