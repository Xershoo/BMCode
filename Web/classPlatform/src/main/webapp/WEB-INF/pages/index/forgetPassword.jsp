...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/index/forgetPwd.css">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/index/forgetPwd.js"></script>

</head>
<body>
<%@ include file="/taglibs/common/head.jsp"%>
<%@ include file="/taglibs/index/forgetPasswordContent.jsp"%>
