...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/css/common/wealthContent_bm.css">
    ...
    <div class="liebiao">
        <div class="title">
            ...
            <div class="m_r_content">
                <div class="pn_fashion" id="basic_info"
                     onclick="location.href='<%=request.getContextPath()%>/persondata/myAccount'">我的账户
                </div>
                <div class="pn_fashion" id="account_info"
                     onclick="location.href='<%=request.getContextPath()%>/order/toShowTradeRecord'">交易记录
                </div>
                <div class="pn_fashion" id="personalPortrait"
                     onclick="location.href='<%=request.getContextPath()%>/persondata/toSetPaySafety'">支付安全
                </div>
                <div style="color: #42b8f6; font-weight: 700;border-bottom: 3px solid #42b8f6;"  class="pn_fashion" onClick="location.href='<%=request.getContextPath()%>/order/studentOrder'">
                    我的订单
                </div>
            </div>
        ...
        <div class="tt">
            <div class="tt1">
                <li>订单号：<input id="orderNum"/></li>
                <li>课程名称：<input id="courseName"/></li>

            </div>
            <div class="tt1">
                <li>购买者：<input id="buyer"/></li>
                <li>提交时间：<input id="submitTime" value="" onClick="WdatePicker()" type="text"/></li>
                <li>
                    <div style="width:119px;height:34px;line-height:30px;text-align: center;" class="chax"><a
                            onclick="query()">查询</a></div>
                </li>
                <li><select id="timeselect">
                ...
                <div class="lxa" style="height:30px;">
                    <input type="radio" name="leixing" value="1" onclick="change()" checked="checked"><span
                        class="a">全部</span> </input> <input type="radio" name="leixing"
                                                            value="2" onclick="changeType(1)"><span
                        class="a">待支付</span> </input> <input
