...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/common.js"></script>
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/order/manageOrder.js"></script>
...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/order/manageOrder.css">
...
<div class="tt22" style="height:30px;"> 
...
<!-- 			<li class="i3">创建于：2015-10-29 12:00:00</li> -->
<!-- 			</div> -->
<!-- 		</div> -->
<!-- 		<div class="qx"> -->
