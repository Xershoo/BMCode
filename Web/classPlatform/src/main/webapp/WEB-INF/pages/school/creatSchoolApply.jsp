...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/school/creatSchool.css">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/school/creatSchoolApply.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/index/head.js"></script>

</head>
<body>
<%@ include file="/taglibs/common/head.jsp"%>
<%@ include file="/taglibs/school/creatSchoolApplyContent.jsp"%>
