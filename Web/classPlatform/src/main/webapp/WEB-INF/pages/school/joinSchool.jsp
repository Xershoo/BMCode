...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/school/joinSchoolContent.css">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/school/joinSchoolContent.js"></script>
...
<%@ include file="/taglibs/school/joinSchoolContent.jsp"%>
