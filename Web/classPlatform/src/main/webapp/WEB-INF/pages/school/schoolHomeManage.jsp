...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/school/schoolHomeManage.css">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/school/schoolHomeManage.js"></script>
...
<body>
	...
	<%@ include file="/taglibs/school/schoolHomeManageDtl.jsp"%>
