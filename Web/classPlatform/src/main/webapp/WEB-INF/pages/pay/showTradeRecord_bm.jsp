...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/pay/showTradeRecord.css">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/pay/showTradeRecord.js"></script>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/index/head.js"></script>

</head>
<body>
<%@ include file="/taglibs/common/head.jsp"%>
<%@ include file="/taglibs/pay/showTradeRecordContent_bm.jsp"%>
