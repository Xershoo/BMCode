...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/common/accountMenu.css">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/certificate/techCertification.js"></script>
...
<body>
	...
	<%@ include file="/taglibs/certificate/techCertification_bm.jsp"%>
