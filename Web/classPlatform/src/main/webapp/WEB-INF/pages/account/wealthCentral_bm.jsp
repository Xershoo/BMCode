...
<title>用户中心</title>
	<link rel="stylesheet" href="<%=path%>/css/account/myAccount.css" />
	<link rel="stylesheet" href="<%=path%>/css/account/dealHistory.css" />
	<link rel="stylesheet" href="<%=path%>/css/account/payPWD.css" />
	<link rel="stylesheet" href="<%=path%>/css/account/paySet.css" />
	<link rel="stylesheet" href="<%=path%>/css/account/setPhone.css" />
...
<body>
	...
	<%@ include file="/taglibs/account/mywealthContent_bm.jsp"%>
