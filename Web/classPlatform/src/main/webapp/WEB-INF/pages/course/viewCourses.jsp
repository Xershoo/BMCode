...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/course/viewCoursesDetail.css">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/course/viewCoursesDetail.js"></script>
...
<%@ include file="/taglibs/course/viewCoursesDetail.jsp"%>
