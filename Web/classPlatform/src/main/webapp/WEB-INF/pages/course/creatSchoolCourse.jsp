...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/course/creatSchoolCourse.js"></script>
	<script type="text/javascript"
...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/course/creatSchoolCourse.css">
<link rel="stylesheet"
...
<!-- 			暂时注释掉 -->
			<div class="laoshi1">
				授课老师  ：<input type="text" id="shoukelaoshi"> </input>
			...
			<div class="jianjie">
				...
				<div class="jj1">
					<textarea   rows="30" cols="50" id="courseDescription"  name="editor01"> </textarea ><span id="jjy" class="yanzheng">
				</div>
			</div>
...
<div class="jiage">
			...
			<div class="jiage3">
				<div class="jg1"><li >根据您输入的信息，我们为您计算出， 日后该课程的收益为</li></div><div  class="jg2"><li id="income"></li></div>
			</div>
