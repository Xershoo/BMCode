...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/course/myCoursesDetail.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/common/leftMenu.css">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/course/myCoursesDetail.js"></script>
...
<%@ include file="/taglibs/course/myCoursesDetail.jsp"%>
