...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/course/updateSchoolCourse.js"></script>
...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/course/updateSchoolCourse.css">
<link rel="stylesheet"
...
<!-- 						<input type="file" id="photo" name="photo" accept="image/gif, image/jpeg" onchange="ajaxFileUpload(this)"><input  type="hidden" value="0" id="f"/> -->
						<input type="button" id="sago" name="photo" value="选择头像" ><input  type="hidden" value="1" id="f"/>
						</div>
						<span>
			...
			<div class="jianjie">
				...
				<div class="jj1">
					<textarea   rows="30" cols="50" id="courseDescription"  name="editor01">${courseBasicInfo.description } </textarea ><span id="jjy" class="yanzheng">
				</div>
			</div>
		...
		<div class="jiaoxuejihua0">
			...
			<div class="ks">
				...
				<input class="laydate-icon" value="<fmt:formatDate value="${courseClasss[0].startTimePlan}" pattern="HH:mm:ss" />" id="start"   type="text" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'H:mm:ss'})" disabled="disabled"></input>
...
<div class="jihua">
			...
			<div class="jiage2">
				<span>报名时间 </span><input type="text" value="<fmt:formatDate value="${courseBasicInfo.signupStartTime}" pattern="yyyy-MM-dd HH:mm" />" id="startb" onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm'})"/>~<input type="text" value="<fmt:formatDate value="${courseBasicInfo.signupEndTime}" pattern="yyyy-MM-dd HH:mm" />" id="endb"  onfocus="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd HH:mm',minDate:'#F{$dp.$D(\'startb\')}'} )"/>
			</div>
...
<div class="jiage">
			...
			<div class="jiage2">
				<span>课程价格  </span><input type="text" value="${courseBasicInfo.priceTotal}" id="coursePrice"/>元
			</div>
			<div class="jiage3">
				<div class="jg1"><li >根据您输入的信息，我们为您计算出， 日后该课程的收益为</li></div><div  class="jg2"><li >+￥10.00。</li><li>-￥10.00。</li></div>
			</div>
