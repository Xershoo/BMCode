...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/jquery.pagination.js"></script>
<script type="text/javascript"
...
<link rel="stylesheet"
	href="<%=request.getContextPath()%>/css/course/searchCoursesDtl.css">
<link rel="stylesheet"
...
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/course/searchCoursesDtl.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/index/head.js"></script>
<script type="text/javascript"
	src="<%=request.getContextPath()%>/js/common/pager.js"></script>
<link rel="stylesheet"
...
<body>
	...
	<%@ include file="/taglibs/course/searchCoursesDtl.jsp"%>
