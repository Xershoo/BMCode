...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/course/videoOnline.css">

<script type="text/javascript" src="<%=request.getContextPath()%>/js/common/jquery-1.7.2.min.js"></script>
<%-- <script type="text/javascript" src="<%=request.getContextPath()%>/js/common/swfobject.js"></script> --%>
<script type="text/javascript" src="<%=request.getContextPath()%>/js/common/jwplayer.js"></script>
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/course/videoOnline.js"></script>

</head>
<body>
<%@ include file="/taglibs/common/head.jsp"%>
<%@ include file="/taglibs/course/videoOnlineContent.jsp"%>
