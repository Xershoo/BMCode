...
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/manageCourse.css">
<link rel="stylesheet" href="<%=request.getContextPath()%>/css/common/page.css">
<script type="text/javascript" src="<%=request.getContextPath()%>/js/course/manageCourse.js"></script>	
...
<div class="m_order">
	...
	<div class="liebiao">
	<div class="title1">
			<div id="xn_title" class="xn_title1"><a class="a1" onclick="changeType(2)">我的订购</a></div>
			<div id="gk_title" class="xn_title1"><a class="a2" onclick="changeType(1)">我的创建</a></div>
			<div id="gk_titlet">
				<div class="cc_title">
					<div class="title2_img"><img id="add" class="img" src="<%=request.getContextPath()%>/images/manageCourse/add_03.png"></div>
					<div class="title2_course"><span onclick="toCreateCourse()">创建课程</span></div>
				</div>
			</div>
	</div>
	<div class="title" id="teacherCourseTitle">
		<div class="check">
			<img
				src="<%=request.getContextPath()%>/images/course/check_05.png"
				id="check1">
		</div>
		<div>全部课程</div>
		<div class="check">
	...
	<div class="title_block"></div>
		<div class="tt">
			<div class="tt1">
				<li>课程名称 ：<input id="courseName"/></li>
				<li id="creator">创课人 ：<input id="creatorName"/></li>
				<li>创建时间 ：<input id="courseTime"  value="" onClick="WdatePicker()" type="text"/></li>
				<li> 
					<div style="width:68px;height:26px;line-height:30px;text-indent: 30px;" class="chax" onclick="searchCourse()"></div> 
				</li>
			...
			<div class="tt2"> 
				...
				<div class="lxa" id="xn_status" >
					<div><input type="radio" name="leixing" value="1" onclick="changeStatus(1,0)" checked="checked"></div>
					<div><span class="a">全部</span> </div>
					<div><input type="radio" name="leixing" value="2" onclick="changeStatus(1,1)"></div>
					<div><span class="a">已完成</span></div>
					<div><input type="radio" name="leixing" value="3" onclick="changeStatus(1,2)"></div>
					<div><span class="a">已取消</span> </div>
				</div>
				<div class="lxa" id="xx_status" style="display:none">
					<input type="radio" name="leixing" value="1" onclick="changeStatus(2,0)" checked="checked">
					<span class="a">全部</span> 
					</input> <input type="radio" name="leixing" value="2" onclick="changeStatus(2,1)">
						<span class="a">已完成</span> 
					</input> 
					<input type="radio" name="leixing" value="3" onclick="changeStatus(2,2)">
						<span class="a">已取消</span> 
					</input>
				</div>
				<div class="lxa" id="gr_status" style="display:none">
					<input type="radio" name="leixing" value="1" onclick="changeStatus(3,0)" checked="checked">
						<span class="a">全部</span> 
					</input> 
					<input type="radio" name="leixing" value="2" onclick="changeStatus(3,1)">
						<span class="a">已完成</span> 
					</input> 
					<input type="radio" name="leixing" value="3" onclick="changeStatus(3,2)">
						<span class="a">已取消</span> 
					</input>
				</div>
			</div>
	...
	<div  id="gr1">
		...
		<div class="biaoge">
			<div class="jibenxinxi">基本信息</div>
			<div class="jiageg">价格</div>
			<div class="renshug">报名学生</div>
			<div class="zhuangtai">课程状态</div>
			<div class="jindu">上课进度</div>
			<div class="caozuog">操作</div>
		</div> 
		-->
		<div id="grTable1"> 
		<%-- 
		<div class="liebiao1">
			...
			<div class="jiage1">
				<!-- <li>￥购买价格</li>
				<li class="jg2">(折扣)</li> -->
				<div class="cor-title">哆来音乐哆来音乐哆来音乐哆来音乐哆来音乐哆来音乐哆来音乐哆来音乐哆来音乐哆来音乐</div>
				<div class="cor-progress">
					<img src="<%=request.getContextPath()%>/images/teacher/progress.gif"> 课程进度：11 / 13&nbsp;&nbsp;&nbsp;&nbsp;<img src="<%=request.getContextPath()%>/images/teacher/apply.gif" class="cor-app"> 报名学生： 4 / 4
				</div>
				<div class="cor-time"><img src="<%=request.getContextPath()%>/images/teacher/time.gif"> 课程时间： 2015/05/12 12:12</div>
			</div>
			<div class="renshu1">￥ 280</div>
			<div class="zhuangtai1">
				<div class="cor-status">已开课</div>
				<div class="cor-view">查看详情</div>
			</div>
		</div> 
		--%>
		</div>
...
<!-- 		</div> -->
		...
		<div id="dialog" title="停售课程" style="display: none">
			...
			<div class="stopCourse_reason"><span id="red">*</span>停售原因:<select id="reason"><option value="">请选择</option><option value="1">个人时间问题</option><option value="2">其他原因</option></select></div>
			...
			<div class="stopCourse_reason">违约金额：<span id="weiyuejin">0</span>元<span  id="chongzhi_stop" style="display:none"> <a href='<%=request.getContextPath()%>/myAccount'><span id="red">*余额不足请先</span><span id="blue"> 充值  </span></a><span id="red">!</span></span></div>
