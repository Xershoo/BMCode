...
<!-- 			</div> -->
			<div class="check"><img src="<%=request.getContextPath()%>/images/course/check_05.png" id="check1" ></div> <div>全部课程</div>
			<div class="check"><img src="<%=request.getContextPath()%>/images/course/check_05.png" id="check2" ></div> <div>最新课程</div>
			<div class="check"><img src="<%=request.getContextPath()%>/images/course/check_05.png" id="check3" ></div> <div>已完成课程</div>
			<div class="check"><img src="<%=request.getContextPath()%>/images/course/check_05.png" id="check4" ></div> <div>已取消课程</div>
		</div>
...
<div class="lx">课程状态 ：</div>
				<div class="lxa" id="xn_status" >
					<div><input type="radio" name="leixing" value="1" onclick="changeStatus(1,0)" checked="checked"></div><div><span class="a">全部</span> </div>
						<div><input type="radio" name="leixing" value="2" onclick="changeStatus(1,1)"></div><div><span class="a">已完成</span></div>
						 <div><input type="radio" name="leixing" value="3" onclick="changeStatus(1,2)"></div><div><span class="a">已取消</span> </div>
				</div>
