    ...
    <div class="all1">
        <div class="leftMenu">
            <a href="/account/course">
                <div class="myCourse">
                    <div><img src="<%=path%>/images/account/1.png"/></div>
        ...
        <a href="/account/wealth">
            <div class="myTreasure">
                <div><img src="<%=request.getContextPath()%>/images/account/3.1.png"/></div>
                <div><font>我的财富</font></div>
            </div>
        </a>
        <a href="/account/settings">
            <div class="personSet">
                <div><img src="<%=request.getContextPath()%>/images/account/4.png"/></div>
                <div><font>个人设置</font></div>
            </div>
        </a>
    </div>
        <div class="rightContrnt">
            <%@ include file="/taglibs/account/item_mywealth_content.jsp" %>
        </div>
    </div>
</div>
