		...
		<div class="c_top_bor">
			<div class="c_top">
				...
				<div class="c_top_right">
					<h1 title="${courseDetail.courseName}" class="pn-cor-dtl"></h1>
					<div class="c_top_tab">
							...
							<shiro:authenticated>
								...
								<c:if test="${courseDetail.canEnterClassid != 0}">
									<input type="button" name="" id="goInClass" value="进入课堂"
										class="c_end in_class c_cursor" onClick="actixs(${courseDetail.canEnterClassid},${courseDetail.courseid});">
								</c:if>
							</shiro:authenticated>
						</div>
					</div>
...
<!-- 				 <div class="piano-course"> -->
<!-- 					<div class="course-img"> -->
<%-- 						<img src="${courseDetail.coverUrl}" alt="" class="img-info"> --%>
<!-- 					</div> -->
<!-- 					<div class="pn-cor-name">北京电影学院</div> -->
<!-- 					<div class="pn-cor-price">￥500元</div> -->
<!-- 				</div> -->
